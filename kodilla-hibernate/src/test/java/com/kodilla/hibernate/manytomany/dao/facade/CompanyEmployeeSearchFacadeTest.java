...
import com.kodilla.hibernate.manytomany.facade.CompanySearchFacade;
...
public class CompanyEmployeeSearchFacadeTest {
    ...
    public void retrieveCompanyLikeTest() {
        ...
        //When
        List<Company> queryResult = companySearchFacade.retriveCompany("oft");
        //Then
    ...
    public void retrieveEmployeeLikeTest() {
        ...
        //When
        List<Employee> queryResult = companySearchFacade.retriveEmployee("mit");
        //Then
