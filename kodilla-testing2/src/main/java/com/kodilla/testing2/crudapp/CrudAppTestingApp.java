...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_WAIT_FOR = "//div[contains(@class, \"tasks-container\")]/form/div/fieldset/select[1]";

    public static void main(String[] args) {
        WebDriver driver = WebDriverConfig.getDriver(WebDriverConfig.FIREFOX);
        driver.get("https://rafalbujak.github.io/bujak.rafal.github.io");
